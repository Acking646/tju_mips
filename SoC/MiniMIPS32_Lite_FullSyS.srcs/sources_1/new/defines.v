...
`define ZERO_WORD       32'h00000000        // 32位数值0
...
`define DOUBLE_REG_BUS  63: 0               // 两个通用寄存器的数据线宽度
...
`define MINIMIPS32_ADDI            8'h20
`define MINIMIPS32_ADDIU           8'h19
`define MINIMIPS32_ADDU            8'h1A
`define MINIMIPS32_SUBU            8'h1B
`define MINIMIPS32_AND             8'h1C
`define MINIMIPS32_ORI             8'h1D
`define MINIMIPS32_OR              8'h1E
`define MINIMIPS32_XOR             8'h1F
`define MINIMIPS32_ANDI            8'h2A
`define MINIMIPS32_SLT             8'h26
`define MINIMIPS32_SLTIU           8'h27
`define MINIMIPS32_BEQ             8'h86
`define MINIMIPS32_BNE             8'h87
`define MINIMIPS32_BGEZ            8'h88

...
elaborate()
{
  xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_12 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_rom xil_defaultlib.inst_rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim inst_rom -key {Behavioral:sim_1:Functional:inst_rom} -tclbatch cmd.tcl -protoinst "protoinst_files/cg_fpga_full.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
